...
namespace TrackItNow.Data.Test
{
    public class TicketRepositoryTest
    {
        ...
        public void CreateTicketTest(string Title, byte TicketResolutionId, byte TicketStatusId, byte TicketTypeId, string Description, byte PriorityId, Guid EmployeeId, Guid ProjectIds, string DueDate)
        {
