...
{
    public class TicketFailingTestData : IEnumerable<object[]>
    {
        ...
        public IEnumerator<object[]> GetEnumerator()
        {
            yield return new object[]
            {
                new NewTicket()
                {
                    Title = "Failing Ticket New 1",
                    Description = "Failing Ticket 1 description" ,
                    DateDue = new DateTime(2023,07,12),
            ...
            yield return new object[]
            {
                ...
                {
                    Title = "Ticket New 2",
                    Description = "Failing Ticket 2 description" ,
                    DateDue = new DateTime(2023,11,22),
                    EmployeeId = "3396543A-204E-4A52-B58E-BB47470ECC64", // Test Employee 1
